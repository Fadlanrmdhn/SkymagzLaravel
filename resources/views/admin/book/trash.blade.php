    ...
    <div class="p-2">
        <nav class="navbar navbar-light bg-light rounded shadow-sm mb-3">
            <div class="container-fluid">
                <span class="navbar-brand mb-0">Recycle Bin Book Management</span>
            ...
            <div class="container-fluid">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.users.index') }}">Book</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Recycle Bin Book</li>
                    </ol>
                </nav>
            </div>
        </nav>
