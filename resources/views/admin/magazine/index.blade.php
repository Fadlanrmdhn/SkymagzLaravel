    ...
    <div class="p-2">
        <nav class="navbar navbar-light bg-light rounded shadow-sm mb-3">
            <div class="container-fluid">
                <span class="navbar-brand mb-0">Magazine Management</span>
        ...
        <div class="table-responsive">
            ...
            <div class="d-flex justify-content-end mb-3 mt-4">
                <a href="{{ route('admin.magazines.trash', ['type' => 'majalah']) }}" class="btn btn-secondary me-2">Data Sampah</a>
                <a href="{{ route('admin.magazines.export', ['type' => 'majalah']) }}" class="btn btn-secondary me-2">Export (.xlsx)</a>
                <a href="{{ route('admin.magazines.create') }}" class="btn btn-success me-2">Tambah Data</a>
            </div>
                    ...
                    @foreach ($magazines as $key => $item)
                        <tr class="text-center">
                            ...
                            <td class="text-center">
                                ...
                                <a href="{{ route('admin.magazines.edit', $item->id) }}"
                                    class="btn btn-sm btn-primary">Edit</a>
                                <form action="{{ route('admin.magazines.delete', $item->id) }}" method="POST"
                                    class="d-inline">
                                    @csrf
                                    @method('DELETE')
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">Detail Majalah</h1>
    ...
    <script>
        ...
        $(function(){
            $('#magazinesTable').DataTable({
                ...
                ajax: "{{ route('admin.magazines.datatables', 'majalah') }}",
